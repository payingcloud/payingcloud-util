...
public final class ObjectId implements Comparable<ObjectId>, Serializable {
    ...
    /**
     * Checks if a string could be an {@code MongoId}.
     *
     * @param hexString a potential MongoId as a String.
    ...
    /**
     * Creates an MongoId using the given time, machine identifier, process identifier, and counter.
     *
     ...
     * @throws IllegalArgumentException if the string is not a valid hex string representation of an MongoId
     */
    ...
    public ObjectId(final ByteBuffer buffer) {
        ...
        // and MongoId's are always in big-endian order.
     ...
     *
     * @return a string representation of the MongoId in hexadecimal format
     */
